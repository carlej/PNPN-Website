		...
		<div class="container-flow">
			<div class = "row no-gutters">
				<div class="col-xl d-flex flex-column" id="EventBanner">
					...
					<!--Banner-->
					<img class="mx-auto d-block" src="CSS/styles/nmap.png" style="margin-top: 0.5em; width: 98%; height: auto; overflow: hidden;">
					...
					<p style="font-family:Pirates; color:black; text-shadow: -.3px -.3px 0 #ff0000, .3px -.3px 0 #ff0000, -.3px .3px 0 #ff0000, .3px .3px 0 #ff0000; font-size: 50px; margin-top: -1.3em; text-align: center;">Nassau Map</p>-->
				</div>
			</div>
		</div>
		<div class="container-flow">
