			...
			<div class = "row no-gutters">
				<div class="col-md d-flex flex-column justify-content-center" id="NewToPirating">
					...
					<p><a class="alone unpressed" style="width: 10em;" href="downScript.php?path=Notes/Codex-Pyratical.pdf">Printable Version</a></p>
						...
						<p>Within our Role Play Nation, there are many who will hold positions which invoke responsibility or authority. There are many Titles and Ranks to be had, within the boundaries defined under <a href="#PERSONA">Persona Naming and Honorifics</a>, and within the Nation we acknowledge and honor them, but it is important to remember that they do not hold any actual, mundane world power in any way. A person with Title or Rank cannot “make” you do anything you have not consented to.</p>
						...
						<p>Refer to <a href="Titles.php">The Rules and Governance Regarding the Acquisition and Retention of Titles Denoting Honorifics, Peerage, and other Appellations within the Nation of Nassau</a> for more information.</p>
						...
						<p>Interested individuals should refer to <a href="DefenderOfNassau.php">The Rules and Governance of the Quest to become the Defender of Nassau</a>.</p>
						...
						<p>For the process of winning a seat on the Pirate Council, please refer to <a href="Council.php">Rules and Governance for the Election of the Council of Nassau</a>.</p>
						...
						<p>During Mock Conflict, should a person land three (3) legal blows to their opponent, or should they hold their opponent “at gunpoint”, they may announce their opponent as their prisoner. This must be done loudly so that others may hear. From that point, the “prisoner” is considered “incapacitated” for purposes of Mock Conflict, and they will be considered as a Hostage per the rules above (see <a href="#Hostages">Hostages</a> under the <a href="#ROLE-PLAYING">ROLE-PLAYING PIRACY</a> section).</p>
