		...
		<div class="container-flow">
			<div class = "row no-gutters">
				<div class="col-xl d-flex flex-column" id="EventBanner">
					...
					<!--Banner-->
					<img class="mx-auto d-block" src="CSS/styles/TortugaNightsStaffBanner.png" style="margin-top: 0.5em; width: 98%; height: auto; overflow: hidden;">
				</div>
			</div>
		</div>
		<div class="container-flow">
			<div class = "row no-gutters">
				<div class="col-md d-flex flex-column justify-content-center" id="NewToPirating">
					<div class="PiratingInfo">
						<p>List and contact information coming soon!</p>
