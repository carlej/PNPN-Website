		...
		<div class="container-flow">
			<div class = "row no-gutters">
				<div class="col-xl d-flex flex-column" id="EventBanner">
					...
					<!--Banner-->
					<img class="mx-auto d-block" src="CSS/styles/LB.png" style="margin-top: 0.5em; width: 98%; height: auto; overflow: hidden;">
				</div>
			</div>
		</div>
		<div class="container-flow" style="margin-top: 2.4em;">
			<div class = "row no-gutters">
