...
$end = $endDate.' '.$endTime;
$cenvertedTime = date('Y/m/d H:i',strtotime('+'.$length.' hour',strtotime($start)));
...
for ($i=1; $i <= floor($numShifts); $i++) { 
	...
	//echo $shiftEndTime;
	$quertyShift = "INSERT INTO `jobs` (`job`, `pay`, `start`, `end`, `length`) VALUES ('$job', '$pay', '$shiftStartTime', '$shiftEndTime', '2')";
